...
class GymV21CompatibilityWrapper(StepAPICompatibility):
    def __init__(self, env, output_truncation_bool):
        super().__init__(env, output_truncation_bool)
...
def make_metaworld_env(cfg):
    ...
    # Gymnasium to gym
    env = GymV21CompatibilityWrapper(env, False)
