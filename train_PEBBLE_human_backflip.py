...
from reward_model_human_backflip import RewardModelHuman_backflip
...
class Workspace(object):
    def __init__(self, cfg):
        ...
        self.reward_model = RewardModelHuman_backflip(
...
@hydra.main(config_path='config/train_PEBBLE_human_backflip.yaml', strict=True)
def main(cfg):
